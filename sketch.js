...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //agregar la codificacion para reprodusir el sonido cada 100 points
    ...
    if(keyDown("space")&& trex.y >= 100) {
        trex.velocityY = -12;
    //1 agregar el sonido de salto cada ves que el t-rex salte
    jumpSound.play();    
    }
    ...
    if(obstaclesGroup.isTouching(trex)){
        gameState = END;
        //2 agregar el sonido de muerte, cuando el t-rex choca con un obtaculo
      dieSound.play();
